...
import (
	...
	// TODO: Import the gophercloud resource type for security_group_rule.
...
func (a *SecurityGroupRuleAuditor) Fix(ctx context.Context, client interface{}, resource interface{}, rule *policy.Rule) error {
	...
	case "log":
		return nil
	default:
		return fmt.Errorf("%s/%s: action %q not implemented", "neutron", "security_group_rule", rule.Action)
	}
}
